...
const btnCript = document.querySelector(".btn button#cript");
const btnDecript = document.querySelector(".btn button#decript");
const btnCopy = document.querySelector(".apresentacao__direita button#copy");
